...
import Labiba from "../pictures/labiba.jpg";

export default function About() {
  return (
    <div className="about-holder">
      <div className="paragraph">
        <h1>Photographer (Labiba Ferdous)</h1>
        <p>
          ...
          etc.Contrary to popular belief, Lorem Ipsum is not simply random text.
      ...
      <div className="imageholder">
        <img className="image" src={Labiba} alt="" />
      </div>
    </div>
  );
}
